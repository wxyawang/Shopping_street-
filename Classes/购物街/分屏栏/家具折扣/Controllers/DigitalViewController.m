...
#define URL_DIGITA @"http://m.meiyou.com/brand_area_catalog/item_list?myuid=73722622&tbuid=AAHHcXGgACLvjRdMA10NBJAl&device_id=20:08:ed:07:f3:79&platform=android&v=1.1.1&imei=359209025863006&bundleid=186&mode=0&app_id=7&auth=3.e6%252FqGrXdHtwYLX3rhveAfIQJQGQnzZC6iWMtmJGTub4%253D&sdkversion=17&catalog_id=10&group_id=2&size=0"
//page=1
@interface DigitalViewController ()<UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout>
{
    NSInteger count;
}
...
-(void)getAllFromNet
{
    ...
    [manger GET:URL_DIGITA  parameters:@{@"page":@(count)} success:^(AFHTTPRequestOperation *operation, id responseObject) {
