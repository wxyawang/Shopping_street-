...
#import "BeautyViewCell.h"
#import "AFNetworking.h"
#import "TaoBaoViewController.h"
#import "UIImageView+AFNetworking.h"
#import "MJRefresh.h"

#define URL_BEAU @"http://m.meiyou.com/brand_area_catalog/item_list?myuid=73722622&tbuid=AAHHcXGgACLvjRdMA10NBJAl&device_id=20:08:ed:07:f3:79&platform=android&v=1.1.1&imei=359209025863006&bundleid=186&mode=0&app_id=7&auth=3.e6%252FqGrXdHtwYLX3rhveAfIQJQGQnzZC6iWMtmJGTub4%253D&sdkversion=17&catalog_id=7&group_id=3&size=0"
//&page=1
@interface BeautyViewController ()<UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout>
{
    NSInteger count;
}
...
- (void)viewDidLoad {
    ...
    [self.collectionView registerNib:[UINib nibWithNibName:@"BeautyViewCell" bundle:nil] forCellWithReuseIdentifier:@"cell"];
...
-(void)getAllFromNet
{
    ...
    [manger GET:URL_BEAU  parameters:@{@"page":@(count)} success:^(AFHTTPRequestOperation *operation, id responseObject) {
...
-(UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    BeautyViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"cell" forIndexPath:indexPath];
    BeaytifulyModel *model = self.DataArray[indexPath.item];
    
    cell.nameLabel.text =model.nameLabel;
    
    cell.vip_price.text = [NSString stringWithFormat:@"%@",model.vip_priceLabel];
