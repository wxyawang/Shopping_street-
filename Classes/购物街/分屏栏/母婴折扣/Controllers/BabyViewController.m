...
#import "BabyModel.h"
#import "BabyViewCell.h"
#import "AFNetworking.h"
#import "TaoBaoViewController.h"
#import "UIImageView+AFNetworking.h"
#import "MJRefresh.h"

#define URL_BABY @"http://m.meiyou.com/brand_area_catalog/item_list?myuid=73722622&tbuid=AAHHcXGgACLvjRdMA10NBJAl&device_id=20:08:ed:07:f3:79&platform=android&v=1.1.1&imei=359209025863006&bundleid=186&mode=0&app_id=7&auth=3.e6%252FqGrXdHtwYLX3rhveAfIQJQGQnzZC6iWMtmJGTub4%253D&sdkversion=17&catalog_id=1&group_id=5&size=0"

//page=1
@interface BabyViewController ()<UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout>
{
    NSInteger count;
}
...
- (void)viewDidLoad {
    ...
    [self.collectionView registerNib:[UINib nibWithNibName:@"BabyViewCell" bundle:nil] forCellWithReuseIdentifier:@"cell"];
...
-(void)getAllFromNet
{
    ...
    [manger GET:URL_BABY  parameters:@{@"page":@(count)} success:^(AFHTTPRequestOperation *operation, id responseObject) {
...
-(UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    BabyViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"cell" forIndexPath:indexPath];
    BabyModel *model = self.DataArray[indexPath.item];
